...
import { Box, Card, CardBody, Stack, Heading, Flex, Divider, Text,  CardFooter, SimpleGrid, Container } from '@chakra-ui/react'
              ...
              >
                ...
                >
                  <CardBody>
                    ...
                    />
                    <Stack mt="4" spacing="1">
                      <Heading size="md">Zeeshan Hanif</Heading>
                      <Text fontSize={"sm"}>
              ...
              >
                ...
                >
                  <CardBody>
                    ...
                    />
                    <Stack mt="4" spacing="1">
                      <Heading size="md"> Asif Shah</Heading>
                      <Text fontSize={"sm"}>
